        ...
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="hidden space-x-4 sm:flex items-center justify-center flex-1">
                ...
                @elseif(auth()->user()->is_manager)
                    ...
                    <a href="{{ route('manager.tasks.index', [], false) }}" class="inline-flex items-center px-3 py-2 rounded-full text-sm font-medium transition duration-150 ease-in-out {{ request()->routeIs('manager.tasks.index') ? 'bg-white border border-gray-300 text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-900' }}">
                        Asignar tareas
                    </a>
