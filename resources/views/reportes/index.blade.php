<x-app-layout>
    ...
    <div class="py-8 bg-gray-50 min-h-screen">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-[2rem] p-8 shadow-sm relative overflow-hidden">
                ...
                <div class="mt-8 flex items-center justify-between">
                    <div>
                        <a href="{{ route('reportes.show', $prof['id']) }}" 
                           class="inline-block px-8 py-2.5 bg-[#0f172a] text-white text-sm font-medium rounded-full hover:bg-black transition shadow-lg">
                    ...
                    <div>
                        @if($prof['has_pending_weeks'])
                            <p class="text-sm text-[#ef4444] italic flex items-center gap-2 font-medium">
                        ...
                        @else
                            <p class="text-sm text-[#22c55e] italic flex items-center gap-2 font-medium">
