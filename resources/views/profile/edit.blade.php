                                        ...
                                        <div class="grid grid-cols-4 gap-4 max-h-60 overflow-y-auto p-2 border rounded-md">
                                            @foreach($avatars as $avatar)
                                                <div class="relative">
                                                    ...
                                                    <label for="avatar_{{ $loop->index }}" class="block cursor-pointer rounded-full border-4 border-transparent peer-checked:border-primary hover:opacity-80 transition-all">
                                            ...
                                            <div class="relative flex items-center justify-center">
                                                ...
                                                <label for="avatar_none" class="block cursor-pointer rounded-full border-4 border-transparent peer-checked:border-primary hover:opacity-80 transition-all w-full aspect-square flex items-center justify-center bg-gray-200">
