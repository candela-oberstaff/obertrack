        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-4 border-l border-gray-100 pl-8">
                    ...
                    <a href="{{ route('reportes.show', $professional->id, false) }}" class="inline-flex items-center gap-2 px-6 py-3 bg-[#22A9C8] text-white rounded-xl font-bold shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all">
                ...
                <div class="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-100">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <div class="text-xs text-gray-400">Consistencia en registro de tareas</div>
                        </div>
