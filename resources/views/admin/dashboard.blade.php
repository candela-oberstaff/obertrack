        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center gap-2">
                                            ...
                                            @if($p['user']->phone_number)
                                                <a href="{{ route('admin.mass-email.show') }}?tab=whatsapp&segment=individual_professional&individual_id={{ $p['user']->id }}" class="p-2 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-colors" title="Mensaje WhatsApp Masivo">
            ...
            <script>
                ...
                function prepareIndividualEmail(userId) {
                    window.location.href = "{{ route('admin.mass-email.show') }}?segment=individual_professional&individual_id=" + userId;
                }
            </script>
