...
<div class="messenger">
    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-header">
            <nav>
                <a href="/dashboard"><i class=""></i> <span class="messenger-headTitle">Ir al Dashboard</span> </a>
                {{-- header buttons --}}
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            ...
            <div class="internet-connection">
                ...
                <span class="ic-noInternet">No tienes internet</span>
            </div>
        </div>
        ...
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Por favor elige una opción para empezar a chatear</span></p>
            </div>
            {{-- Typing indicator --}}
